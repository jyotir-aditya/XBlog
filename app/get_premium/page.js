...
const page = () => {
  ...
  return (
    <div className="pt-[11vh] pb-4 sm:pb-0">
      <div className="w-[100vw]">
        <div className="w-full flex flex-col items-center gap-2 justify-center">
          <div className="sm:text-5xl text-4xl w-[60vw] text-center font-robo font-semibold">
            Upgrade to Premium
          </div>
          <div className="sm:text-xl text-lg w-[80vw] text-center font-slab">
        ...
        <div className="CardContainer flex flex-wrap justify-center gap-4 items-center py-4 w-[100vw] ">
