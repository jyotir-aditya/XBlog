...
const FeedUsers = () => {
  ...
  return (
    <div>
        <div className="bg-white min-h-[20vh] px-2 pb-4 pt-2 shadow-sm border border-gray-200 rounded-xl ">
           <h1 className="text-xl font-robo font-bold"> Top Authors </h1>
           <div>{topAuthors.map((item,index)=>(<div key={index}>
            <div className="Card  flex h-full  mt-2 bg-white p-2 rounded-full shadow-md ">
              <div className="h-full flex  self-center ">
             <Image src={item.image} alt="user picture" width={45} height={45} className=" rounded-full"/>
              </div>
             ...
             <div className="ButtonStucture  flex align-middle content-center items-center">
                <div className="border-[2px]  rounded-full py-2 px-4"><Follow id={item.id} /></div>
                </div>
