...
const ProfileFeed = ({ userId }) => {
  ...
  return (
    <div>
      <div className="TopMenu w-full h-[5vh] mt-[8vh] flex justify-between px-[1vw] border-b">
        <button className="font-semibold font-robo h-full flex flex-col justify-between items-center">
          Posts
          <div className="w-[4vw] border-[3px] border-black rounded-full" />
        </button>
      </div>
      {Posts &&
        Posts.length > 0 &&
        Posts.map((post, index) => (
          <div
            key={index}
            className="Card rounded-md shadow-md bottom-2 w-[50vw] mt-[2vw] h-fit p-[1vw] bg-white"
          >
              ...
              <div className="inner-element">
                <div className="TextandTags flex flex-col h-full justify-between">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {status === "authenticated" &&pathname === `/${session.user.username}` && (
                      <div className="">
