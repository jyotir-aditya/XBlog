  ...
  return (
    <div className="w-full h-full border-t bg-gradient-to-l from-sky-100 to-green-100 overflow-hidden">
      <div className="w-full h-full  ">
        <div className="sm:mt-[18vh] mt-[20vh] ml-[5vw]">
          ...
          <div className="button">
            <button onClick={() => signIn("google")}>
              <div className="border-[2px] bg-black text-white py-[1vw] mt-[30vh] sm:mt-[5vh] px-4 sm:px-[1.5vw] text-lg font-robo sm:text-[1.5vw] rounded-full ">
                Explore Now
              </div>
            </button>
          </div>
